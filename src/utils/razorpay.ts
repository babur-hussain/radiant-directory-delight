...
/**
 * Generate a proper Razorpay order ID
 * Note: In production, order IDs should be generated by your backend
 * This is a temporary client-side implementation
 */
export const generateOrderId = (): string => {
  return `order_${Date.now().toString()}${Math.random().toString(36).substring(2, 7)}`;
};
