...
// Make this interface accept both types of Business
interface BusinessCardProps {
  business: Business | any; // Use any to accommodate both types
}

const BusinessCard: React.FC<BusinessCardProps> = ({ business }) => {
  // Use ensureTagsArray to handle both types of tag formats
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="text-gray-700">{business.rating || 0}</span>
          <span className="text-gray-500 ml-1">({business.reviews || 0} reviews)</span>
        </div>
