    ...
    <section className="relative bg-gradient-to-b from-primary/10 to-background pt-10 md:pt-16 pb-6 md:pb-8">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="hero-content text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-3 md:mb-4">Grow Bharat Vyapaar</h1>
          <p className="text-lg md:text-xl mb-4 md:mb-6">Discover Indian businesses</p>
        ...
        <div className="mt-6 md:mt-8 w-full max-w-4xl mx-auto">
