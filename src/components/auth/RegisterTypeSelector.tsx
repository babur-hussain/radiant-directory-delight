  ...
  return (
    <div>
      ...
      >
        <Label
          htmlFor="user"
          className={`flex flex-col items-center justify-between rounded-md border-2 p-4 cursor-pointer ${selectedType === 'User' ? 'border-primary' : 'border-muted hover:border-muted-foreground/50'}`}
        >
        ...
        <Label
          htmlFor="business"
          className={`flex flex-col items-center justify-between rounded-md border-2 p-4 cursor-pointer ${selectedType === 'Business' ? 'border-primary' : 'border-muted hover:border-muted-foreground/50'}`}
        >
        ...
        <Label
          htmlFor="influencer"
          className={`flex flex-col items-center justify-between rounded-md border-2 p-4 cursor-pointer ${selectedType === 'Influencer' ? 'border-primary' : 'border-muted hover:border-muted-foreground/50'}`}
        >
