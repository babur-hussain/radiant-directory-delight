  ...
  return (
    <div className="admin-layout flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 md:ml-64 flex flex-col min-h-screen">
        ...
        <header className="admin-header md:hidden sticky top-0 left-0 right-0 z-[9999] bg-white dark:bg-gray-800 shadow-sm">
        ...
        {/* Desktop header */}
        <header className="admin-header hidden md:block sticky top-0 left-0 right-0 z-[9999] bg-white dark:bg-gray-800 shadow-sm">
          <div className="p-4 border-b flex items-center justify-between">
            <h1 className="text-xl font-semibold">Admin Panel</h1>
          </div>
        </header>
