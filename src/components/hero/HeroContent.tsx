...
const HeroContent: React.FC = () => {
  return (
    <div className="flex flex-col items-center text-center mb-12">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-[#0C3C60] mb-6 text-balance max-w-4xl">
        Discover and Grow with
        <span className="text-[#F5962C] block mt-2">Bharat Vyapaar</span>
      </h1>
